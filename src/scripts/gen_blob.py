...
def generate_neutrophil_nucleus():
    ...
    img[non_zero_indices[0][bottom_half_indices], non_zero_indices[1][
        bottom_half_indices]] = 0  # Set non-zero values to zero
    ...
    img[non_zero_indices[0][right_half_indices], non_zero_indices[1][
        right_half_indices]] = 0  # Set non-zero values to zero
...
def generate_all_images(count=1000, count_test=300):
    ...
    for i in range(count_test, count_test * 2):
        ...
        file.close()
        test_counter += 1
        print("Progress: ", test_counter, " out of ", count_test * 2, " images, ",
              (test_counter / count_test * 2) * 100, "%")
